...
// (binary-op op value value)
// (unary-op op value)
// (call value (param param ...))
// (field value field)
// (name name (type type ...))
// (literal lit)
...
// _, i8, u8, i16, u16, i32, u32, bool
// (named name (param param ...))
// (ptr type)
...
// (def-extern-fn name (type type ...) (param param ...) return-type body)
// (def-extern-fn name (type type ...) (param param ...) return-type)
// (def-fn name (type type ...) (param param ...) return-type body)
// (def-fn name (type type ...) (param param ...) return-type)
...
// (def-struct name (type type ...) (field field ...))
*/